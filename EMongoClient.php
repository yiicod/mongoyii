...
//    public $setSlaveOkay = false;
    ...
    public function connect()
    {
        if (!extension_loaded('mongodb')) {
            ...
            yii::t(
            'yii', 'We could not find the MongoDB extension ( https://github.com/mongodb/mongo-php-driver ), please install it'
            )
            );
        }
        ...
        $this->_mongo = new Client($this->server, $this->options);
...
//        }
    ...
    {
        $this->_db = $this->getConnection()->selectDatabase($name);
    }
    ...
    {
        return iterator_to_array($this->getDB()->$collection->aggregate($pipelines));
    }
