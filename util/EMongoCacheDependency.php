    ...
    protected function getDbConnection()
    {
        if ($this->_db !== null) {
            ...
            if (($this->_db = Yii::app()->getComponent($this->connectionID)) instanceof EMongoClient) {
                ...
                Yii::t(
                        'yii', 'EMongoCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a EMongoClient application component.', ['{id}' => $this->connectionID]
                )
                );
            }
        }
